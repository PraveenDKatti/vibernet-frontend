        ...
        return (
            <div className="flex flex-col space-y-1.5 w-full">
                ...
                <textarea
                    ...
                    ref={ref}
                    rows={rows}
                    className={`w-full px-4 py-3 rounded-xl bg-white dark:bg-zinc-800 border text-zinc-800 dark:text-zinc-100 placeholder-zinc-400 text-sm outline-none transition-all duration-200 resize-none
            ${error
